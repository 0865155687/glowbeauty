...
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('GlowBeauty Soft Veil Loose Powder','GlowBeauty','Phấn phủ',299000,10,'b999eddd-f76a-4dc3-82a7-a5ea08c5e78e.png','Phấn phủ GlowBeauty giúp cố định lớp nền, tạo hiệu ứng mịn lì nhưng không làm mặt bị dày.','Kiềm dầu nhẹ, giảm bóng nhờn, giúp lớp nền bền và mịn hơn.','Hạt phấn siêu mịn, finish tự nhiên, phù hợp nhiều tông da.','Dặm nhẹ vùng chữ T, dưới mắt và vùng dễ đổ dầu sau bước kem nền.',1,4);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('GlowBeauty Glow Velvet Lipstick','GlowBeauty','Son môi',279000,10,'e3994ca6-7672-4e2d-9dc0-63a1c99cfbbb.png','Son GlowBeauty tông đỏ hồng nữ tính, chất son mịn, lên màu rõ và phù hợp nhiều phong cách.','Giúp môi nổi bật, làm sáng khuôn mặt, phù hợp đi học, đi làm và dự tiệc.','Kết cấu velvet mềm, sắc tố rõ, hạn chế khô môi khi dùng đúng cách.','Thoa trực tiếp lên môi hoặc tán lòng môi để tạo hiệu ứng nhẹ nhàng.',1,5);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('GlowBeauty Rose Hydrating Toner','GlowBeauty','Toner & Essence',259000,10,'d766a7f3-1211-40d7-b144-7c50b8323349.png','Toner hoa hồng GlowBeauty hỗ trợ cân bằng da sau rửa mặt và chuẩn bị da cho các bước dưỡng tiếp theo.','Cấp ẩm nhẹ, làm dịu da, giúp da mềm và dễ hấp thu serum hơn.','Chiết xuất hoa hồng, thành phần cấp ẩm, kết cấu nước nhẹ.','Đổ ra bông tẩy trang hoặc lòng bàn tay, vỗ nhẹ sau bước làm sạch.',1,6);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('GlowBeauty Premium Combo 7 sản phẩm','GlowBeauty','Combo',1499000,10,'80c93bee-84bb-4c67-8b4d-c1672ef08fcd.png','Combo chăm sóc và trang điểm toàn diện gồm sữa rửa mặt, toner, serum, kem dưỡng, cushion, son và bảng mắt.','Tiết kiệm chi phí, đầy đủ sản phẩm cơ bản cho routine làm đẹp hằng ngày.','Bộ sản phẩm được phối theo tông hồng rose-gold, phù hợp làm quà tặng.','Dùng theo thứ tự: làm sạch, cân bằng, serum, kem dưỡng, nền, mắt và son.',1,7);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('GlowBeauty Luxury Makeup Banner Collection','GlowBeauty','Combo',2350000,10,'3d7437b9-c6c3-4326-a9df-ca2ee66a36d6.png','Bộ sưu tập makeup cao cấp của GlowBeauty gồm sản phẩm nền, son, phấn mắt và phấn má tông rose-gold.','Mang lại phong cách trang điểm sang trọng, đồng bộ và nổi bật.','Các sản phẩm trong bộ có tông màu dễ dùng, phù hợp nhiều dịp.','Sử dụng từng sản phẩm theo nhu cầu trang điểm cá nhân.',1,8);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('Biore Sạch Dịu Nhẹ Sáng Mịn & Dưỡng Ẩm','Biore','Sữa rửa mặt',89000,10,'0001.jpg','Sữa rửa mặt Biore giúp làm sạch da nhẹ nhàng, phù hợp sử dụng hằng ngày.','Làm sạch bụi bẩn, dầu thừa, hỗ trợ da sáng mịn và mềm hơn sau khi rửa.','Chiết xuất nước vo gạo, công nghệ thanh lọc da, kết cấu tạo bọt nhẹ.','Làm ướt mặt, lấy lượng vừa đủ tạo bọt, massage 30-60 giây rồi rửa sạch.',1,9);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('Simple Refreshing Facial Wash','Simple','Sữa rửa mặt',125000,10,'rua_mat_simple-3.jpg','Sữa rửa mặt Simple nổi bật với công thức dịu nhẹ, phù hợp da nhạy cảm.','Làm sạch da mà không gây cảm giác khô căng, giúp da thông thoáng.','Không hương liệu, không màu nhân tạo, công thức lành tính.','Dùng sáng và tối, massage nhẹ trên da ẩm rồi rửa sạch.',1,10);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('CeraVe Foaming Facial Cleanser','CeraVe','Sữa rửa mặt',365000,10,'SRM-Cerave-Foaming-Facial-For-Normal-To-Oily-Skin-.jpeg','Sữa rửa mặt tạo bọt CeraVe dành cho da thường đến da dầu.','Làm sạch dầu thừa, hỗ trợ bảo vệ hàng rào ẩm tự nhiên của da.','Ceramides, Niacinamide và Hyaluronic Acid.','Dùng 1-2 lần/ngày, tránh vùng mắt và rửa lại bằng nước sạch.',1,11);
INSERT INTO products(name,brand,category,price,stock,image,description,benefit,ingredients,usage_text,status,sort_order) VALUES ('Cetaphil Gentle Skin Cleanser','Cetaphil','Sữa rửa mặt',345000,10,'sua-rua-mat-diu-nhe-cetaphil-gentle-skin-cleanser-473ml-070323-050017-600x600.jpg','Sữa rửa mặt Cetaphil Gentle Skin Cleanser phù hợp da khô, da nhạy cảm và dùng hằng ngày.','Làm sạch dịu nhẹ, hỗ trợ duy trì độ ẩm và giảm cảm giác căng da.','Công thức dịu nhẹ, không xà phòng mạnh, phù hợp nhiều loại da.','Massage trên da ẩm, rửa sạch hoặc lau bằng bông mềm tùy nhu cầu.',1,12);
...
UPDATE products SET product_code = CONCAT('GB-', LPAD(id, 4, '0')) WHERE product_code IS NULL OR product_code = '';

-- ===== Dữ liệu mẫu khách hàng + doanh thu tháng 1-4/2026 =====
INSERT INTO users(name,email,password,role) VALUES
('Nguyễn Thu Hà','thuhaglow@example.com','$2y$12$osim3.pR9yKQReEenQmV/.LCinnNcGLmNPxpSGpnixN7e2azPkaOu','customer'),
('Trần Minh Anh','minhanhglow@example.com','$2y$12$osim3.pR9yKQReEenQmV/.LCinnNcGLmNPxpSGpnixN7e2azPkaOu','customer'),
('Lê Phương Linh','phuonglinhglow@example.com','$2y$12$osim3.pR9yKQReEenQmV/.LCinnNcGLmNPxpSGpnixN7e2azPkaOu','customer'),
('Phạm Ngọc Mai','ngocmaiglow@example.com','$2y$12$osim3.pR9yKQReEenQmV/.LCinnNcGLmNPxpSGpnixN7e2azPkaOu','customer');

INSERT INTO orders(id,customer_name,phone,address,note,total,status,created_at) VALUES
(1,'Nguyễn Thu Hà','0912345678','Hoàn Kiếm, Hà Nội','Khách mua combo đầu năm',1848000,'Hoàn thành','2026-01-10 09:18:00'),
(2,'Trần Minh Anh','0987654321','Cầu Giấy, Hà Nội','Giao giờ hành chính',1326000,'Hoàn thành','2026-01-22 14:35:00'),
(3,'Lê Phương Linh','0901122334','Đống Đa, Hà Nội','Tư vấn thêm toner',2609000,'Hoàn thành','2026-02-06 10:12:00'),
(4,'Phạm Ngọc Mai','0933445566','Hai Bà Trưng, Hà Nội','Khách đặt online',1085000,'Hoàn thành','2026-02-20 16:40:00'),
(5,'Hoàng Bảo Ngọc','0977889900','Thanh Xuân, Hà Nội','Khách quen',2719000,'Hoàn thành','2026-03-08 11:05:00'),
(6,'Vũ Khánh Ly','0966112233','Long Biên, Hà Nội','Gói quà tặng',1697000,'Hoàn thành','2026-03-27 15:22:00'),
(7,'Đỗ Minh Châu','0944556677','Nam Từ Liêm, Hà Nội','Thanh toán khi nhận hàng',2649000,'Hoàn thành','2026-04-05 08:58:00'),
(8,'Bùi Hồng Nhung','0922334455','Hà Đông, Hà Nội','Khách chọn son + nền',1504000,'Hoàn thành','2026-04-19 19:10:00');

INSERT INTO order_items(order_id,product_id,product_name,price,quantity) VALUES
(1,7,'GlowBeauty Premium Combo 7 sản phẩm',1499000,1),(1,1,'GlowBeauty 4 Colors Eyeshadow',349000,1),
(2,3,'GlowBeauty Radiant Foundation',389000,2),(2,5,'GlowBeauty Glow Velvet Lipstick',279000,1),(2,2,'GlowBeauty Soft Rose Blush',259000,1),(2,10,'Simple Refreshing Facial Wash',125000,1),
(3,8,'GlowBeauty Luxury Makeup Banner Collection',2350000,1),(3,6,'GlowBeauty Rose Hydrating Toner',259000,1),
(4,26,'Makeup By Mario SurrealSkin Foundation',620000,1),(4,17,'Rare Beauty Soft Pinch Tinted Lip Oil',395000,1),(4,9,'Biore Sạch Dịu Nhẹ Sáng Mịn & Dưỡng Ẩm',89000,1),
(5,7,'GlowBeauty Premium Combo 7 sản phẩm',1499000,1),(5,22,'YSL Make Me Blush Bold Blurring Blush',950000,1),(5,5,'GlowBeauty Glow Velvet Lipstick',279000,1),
(6,27,'Make Up For Ever HD Skin Foundation',890000,1),(6,31,'3CE Stylenanda Waterful Foundation',420000,1),(6,3,'GlowBeauty Radiant Foundation',389000,1),
(7,8,'GlowBeauty Luxury Makeup Banner Collection',2350000,1),(7,4,'GlowBeauty Soft Veil Loose Powder',299000,1),
(8,28,'Maybelline Super Stay Lumi Matte Foundation',298000,2),(8,23,'Dasique Blending Mood Cheek Palette',315000,1),(8,18,'Merzy The Watery Dew Tint V6 Siren',179000,2),(8,21,'Romand Better Than Cheek Blush',235000,1);

-- V57 update payment data
UPDATE orders SET payment_status='Đã thanh toán' WHERE payment_status IS NULL OR payment_status='';
UPDATE orders SET payment_status='Chưa thanh toán' WHERE payment_status NOT IN ('Chưa thanh toán','Đã thanh toán');
UPDATE orders SET payment_code = CONCAT('GBPAY', DATE_FORMAT(created_at, '%y%m%d'), LPAD(id, 5, '0')) WHERE payment_code IS NULL OR payment_code='';
UPDATE order_items oi JOIN products p ON p.id=oi.product_id SET oi.product_code=p.product_code WHERE oi.product_code IS NULL OR oi.product_code='';

-- Bảng lưu khách hàng gửi form liên hệ tư vấn
