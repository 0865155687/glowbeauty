...
<head>
    ...
    <link rel="stylesheet" href="<?= gb_url('public/assets/css/style.css?v=20260610-mobile-icon-v9') ?>">
    <link rel="stylesheet" href="<?= gb_url('public/assets/css/cart-modern.css?v=20260610-mobile-icon-v9') ?>">
</head>
