...
<table class="admin-table admin-table-v35 order-admin-table">
  <tr><th>Mã</th><th>Khách hàng</th><th>SĐT</th><th>Địa chỉ</th><th>Tổng tiền</th><th>Trạng thái</th><th>Thanh toán</th><th>Ngày tạo</th><th>Chi tiết</th></tr>
  <?php if(empty($orders)): ?><tr><td colspan="9" class="empty-admin">Chưa có đơn hàng phù hợp.</td></tr><?php endif; ?>
